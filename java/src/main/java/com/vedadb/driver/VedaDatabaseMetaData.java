...
/**
 * DatabaseMetaData implementation for VedaDB.
 */
public class VedaDatabaseMetaData implements DatabaseMetaData {

    private final VedaConnection connection;

    VedaDatabaseMetaData(VedaConnection connection) {
    ...
    @Override public String getURL() throws SQLException { return VedaDriver.URL_PREFIX; }
    @Override public String getUserName() throws SQLException { return ""; }
    ...
    @Override public String getDatabaseProductName() throws SQLException { return "VedaDB"; }
    @Override public String getDatabaseProductVersion() throws SQLException { return "1.0.0"; }
    @Override public String getDriverName() throws SQLException { return "VedaDB JDBC Driver"; }
    ...
    @Override public String getSQLKeywords() throws SQLException { return "VEDA,VECTOR,CACHE"; }
    ...
    @Override public int getMaxCatalogNameLength() throws SQLException { return 128; }
    ...
    private ResultSet emptyResultSet() throws SQLException {
        return connection.createStatement().executeQuery("SELECT 1 WHERE 1=0");
    }
}
